...
/** invokeUserInterfaceInfo POST /api/userInterfaceInfo/invoke */
export async function invokeUserInterfaceInfoUsingPost(
  body: API.UserInterfaceInfoInvokeRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseObject_>('/api/userInterfaceInfo/invoke', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
